...
Tags: real estate, idx, MLS, listings, RETS, webAPI
...
Estatik plugin helps you create easy-to-use WordPress real estate website for real estate agencies and single agents. Comes with free theme and quick demo setup feature! 
Visit [www.estatik.net](http://estatik.net/) for more information.

Visit [demo](http://demo.estatik.net/) of Estatik plugin or [demo](http://realtor.estatik.net) on one of Estatik native themes.
...
* Subscription plans with payments via PayPal (PRO)
* CSV import (PRO)
* agents support (PRO)
...
* Estatik Native Theme (FREE!) - [DEMO](http://native.estatik.net/)
* Estatik Trendy Theme - [DEMO](http://trendy.estatik.net/)
* Estatik Project Theme - [DEMO](http://project.estatik.net)
* Estatik Portal Theme - [DEMO](http://portal.estatik.net/)
* Estatik Realtor Theme - [DEMO](http://realtor.estatik.net)



Upgrade to [Estatik PRO](https://estatik.net/product/estatik-professional/) and get:

* Lifetime updates 
* Use on unlimited domains
* Free support for 1 year (1 website)




It also works with the most of WordPress themes but if you have any issues, just [drop us a message](https://estatik.net/contact-us/) and we will add support of your theme for free.
...
Please visit [this documentation](https://estatik.net/estatik-plugin-documentation/#document-24) to get a full list of shortocodes.
Visit official [Estatik Pro page](http://estatik.net/product/estatik-professional/) to get full information.
How to add custom fields [tutorials >>](https://estatik.net/estatik-plugin-documentation/#cat-3)
...
* [MLS/IDX integration](https://estatik.net/estatik-premium-rets-version-released/) (via [RETS](https://estatik.net/product/estatik-premium-rets/))
* [Installation and configuration](http://estatik.net/installation-setup/)
* [Custom real estate website](https://estatik.net/custom-real-estate-website/)
* [Customization service](https://estatik.net/estatik-customization/)
...
With Estatik PRO or Premium version you get free support for 1 year and 1 website. Support for Simple free version is limited to WordPress forum. Please post your question here at Support forum, or contact us >> http://estatik.net/contact-us/ and we will help you with any issues.
...
We developed [Estatik Premium](https://estatik.net/product/estatik-premium-rets/) version for integration via RETS or RESO Web API. 
...
No, you will not lose your listings. Read [here >>](https://estatik.net/estatik-plugin-documentation/#document-62) how to upgrade.
...
8. Plugin demo on Theme Trendy (all properties view)

9. Plugin demo on Theme Trendy (single property view)

10. Plugin demo on Theme Trendy (Table view with Search in sidebar)

11. Plugin demo on Theme Trendy (2 columns layout)

12. Plugin demo on Theme Trendy (List layout with horizontal search)

13. Plugin demo on Theme Trendy (List layout)

14. Plugin demo on Theme Trendy (Map view)

15. Plugin demo on Theme Trendy (Agents view)

16. Plugin demo on Theme Trendy (Blog view)

17. Plugin demo on Theme Trendy (Single post view)
